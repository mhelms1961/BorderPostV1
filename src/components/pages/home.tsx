  ...
  const features: Feature[] = [
    {
      ...
      description: "Drag-and-drop your favorite clips in seconds",
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 space-y-8">
                ...
                <p className="text-lg md:text-xl text-gray-600">
                  Create video postcards of your wedding films in seconds. Give
                  your couples something to get excited about while you complete
                  their films!
                </p>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  />
                  <CheckCircle2 className="h-4 w-4 text-black" />
                  <span>Save time editing yourself</span>
                  <Separator
                    orientation="vertical"
                    className="h-4 mx-2 bg-gray-300"
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Drag-and-drop your favorite clips in seconds
                </p>
